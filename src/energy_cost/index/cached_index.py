...
class CachedIndex(Index):
    ...
    ----------
    source:
        The underlying index to fetch data from (e.g. EntsoeDayAheadIndex).
    file_name:
        Name of the cache file (without extension) to use for this index.
    cache_dir:
    ...
    def _cache_path(self) -> Path:
        ...
        return self.cache_dir / f"{self.file_name}.pkl"
